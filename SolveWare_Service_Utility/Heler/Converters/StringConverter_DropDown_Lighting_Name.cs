...
{
    public class StringConverter_DropDown_Lighting_Name : StringConverter
    {
        ...
        {
            IResourceProvider provider = SolveWare.Core.MMgr.Get_Single_Tool_Resource(Tool_Resource_Kind.Lighting);
