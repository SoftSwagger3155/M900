...
{
    [ROIKindAttribute]
    public class ROI_CrossLine : ROIBase, IROI
    {
        ...
        //Vertical Line
        private double row3, col3;   // first end point of line
        private double row4, col4;   // second end point of line

        private double midR, midC;   // midPoint of line

        private HXLDCont arrowHandleXLD;

        public ROI_CrossLine(string Name)
        {
            RoiName = Name;
