...
namespace SolveWare_Service_Vision.Templates
{
    public class Template_Scaled_PatternMatch
    {
        public void Execute(HWindow hv_WindowHandle, HTuple hv_ModelID, HObject ho_GrayImage)
        {
            ...
            try
            {
                ...
                dev_display_shape_matching_results(hv_ModelID, "green", hv_Row1, hv_Column1,
                    hv_Angle, 1, 1, 0);
                ...
                //}
                string result = $"操作结果 Row {Math.Round((double)hv_Row1,0)} Column {Math.Round((double)hv_Column1, 0)}";

                //设置字体风格
                HTuple hv_FontWithSize = new HTuple() ;
                ...
                //hv_FontWithSize = "Arial";
                //HOperatorSet.SetFont(hv_WindowHandle, "宋体-50");
                hv_WindowHandle.SetColor("green");
                hv_WindowHandle.SetTposition(10, 10);
                hv_WindowHandle.WriteString(result);
                hv_WindowHandle.SetColor("orange");
