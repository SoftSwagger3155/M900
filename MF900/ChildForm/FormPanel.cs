...
namespace MF900
{
    ...
    public partial class FormPanel : Form
    {
        ...
        public FormPanel(FormProgramSet form)
        {
            InitializeComponent();
            formProgramSet = form;
            formCurrent = formProductData;
            //Showsubform("FormProductData");
        }
        /// <summary>
        /// 界面切换
        /// </summary>
        ...
        {
            if (MessageBox.Show("是否完成程序参数修改且保存完成？", "提示", MessageBoxButtons.YesNo) == DialogResult.No)
                return;
            
            FormProgramSet.proSetSelect = FormProgramSet.ProSetSelect.None;
